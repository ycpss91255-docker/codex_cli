...
Tests validate: Codex CLI availability, dev tools, system config (non-root user, timezone, locale), absence of other AI CLIs (claude, gemini), and absence of unnecessary tools (tmux, vim, fzf, terminator).
